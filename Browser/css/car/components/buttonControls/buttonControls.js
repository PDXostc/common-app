...
(function ($) {
    "use strict";
    /**
     * Represents data UI control element that is used to display audio controls to operate {{#crossLink "CarTheme.AudioPlayer"}}{{/crossLink}} class.
    ...
    /** 
     * jQuery extension method for {{#crossLink "CarTheme.ButtonControlsObj"}}{{/crossLink}} plugin.
