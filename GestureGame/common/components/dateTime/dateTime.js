...
(function ($) {
	...
	var ClockPlugin = {
			...
			init: function (seconds) {
				this.empty();
				var appendText = '<div id="clock" class="clockElemnt fontSizeLarge  fontColorDark fontWeightBold">TIME</div>';
				appendText += '<div id="date" class="dateElemnt fontSizeLarge fontColorDark fontWeightBold">DATE</div>';
