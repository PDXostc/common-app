 ...
 *
 * * {{#crossLink "CarTheme.AlphabetBookmark"}}{{/crossLink}} component
...
(function($) {
	...
	var Library = {
		...
		/**
		 * Sets library main content template path stored in {{#crossLink "CarTheme.Library/contentDelegate:property"}}Library.contentDelegate{{/crossLink}}.
		 * 
		...
		/**
		 * Shows sub panel and triggers {{#crossLink "CarTheme.Library/eventClick_showSubpanel:event"}}eventClick_showSubpanel{{/crossLink}}.
		 * 
		 * @method showSubpanel
		 */
		showSubpanel : function(completeCallback) {
			if ($("#libraryTopSubPanel").is(":hidden")) {
				...
				/**
				 * Fired when {{#crossLink "CarTheme.Library/showSubpanel:method"}}showSubpanel{{/crossLink}} is called.
				 * It's standard JQuery event and it fires on Library object.
				 * 
		...
		/**
		 * Hides sub panel and triggers {{#crossLink "CarTheme.Library/eventClick_closeSubpanel:event"}}eventClick_closeSubpanel{{/crossLink}} event.
		 * 
		...
		closeSubpanel : function(completeCallback) {
			if ($("#libraryTopSubPanel").is(":visible")) {
				...
				/**
				 * Fired when {{#crossLink "CarTheme.Library/closeSubpanel:method"}}closeSubpanel{{/crossLink}} is called.
				 * It's standard JQuery event and it fires on Library object.
				 * 
		...
		/**
		 * Triggers {{#crossLink "CarTheme.Library/eventClick_menuItemBtn:event"}}eventClick_menuItemBtn{{/crossLink}} event 
		 * and calls {{#crossLink "CarTheme.Library/setTopTabIndex:method"}}setTopTabIndex{{/crossLink}} to set
		 * {{#crossLink "CarTheme.Library/selectedTopTabIndex:propety"}}selectedTopTabIndex{{/crossLink}} automatically after clicking on tab.
		 * 
		...
		libraryTabClick : function(index) {
			...
			/**
			 * Fired when {{#crossLink "CarTheme.Library/libraryTabClick:method"}}libraryTabClick{{/crossLink}} is called.
			 * It's standard JQuery event and it fires on Library object.
			 * 
			 * **indexObject example:**
			 * 
	...
	/** 
	 * jQuery extension method for {{#crossLink "CarTheme.Library"}}{{/crossLink}} plugin.
