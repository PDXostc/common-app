...
/** 
 * Class provides AMB related functionality utilizing `tizen.vehicle` API for signals used in HTML applications. This component is usually initialized by {{#crossLink "Services.Bootstrap"}}{{/crossLink}} class
 * and can be later accessed using {{#crossLink "Services.Bootstrap/carIndicator:property"}}{{/crossLink}} property. Signals recognized by this class needs to be registered in property
 * {{#crossLink "Services.CarIndicator/_mappingTable:property"}}{{/crossLink}}. 
 * 
 * To attach and detach to particular property register new callback object using {{#crossLink "Services.Bootstrap/carIndicator:addListener"}}{{/crossLink}} method, e.g.:
 * 
