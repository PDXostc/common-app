 ...
 * Internally uses `JSON.stringify()` and  `JSON.parse()` so its possible to store even complex structures as values. This component is usually initialized by {{#crossLink "Services.Bootstrap"}}{{/crossLink}} class
 * and can be later accessed using global {{#crossLink "Services.Configuration"}}{{/crossLink}} object.
 * 
 * To attach and detach listener to detect changes in configuration register new callback function using {{#crossLink "Services.Configuration/addUpdateListener:method"}}{{/crossLink}} method, e.g.:
 * 
 ...
 * 
 * Changes are detected on global configuration level so each listener is responsible for detecting changes in interested properties. Use {{#crossLink "Services.Configuration/get:method"}}{{/crossLink}} 
 * method to get new value or {{#crossLink "Services.Configuration/set:method"}}{{/crossLink}} method to set and save new value.
 *
 * In special cases it's possible to force update in configuration file by calling {{#crossLink "Services.Configuration/save:method"}}{{/crossLink}} method or force update of configuration object by calling
 * {{#crossLink "Services.Configuration/reload:method"}}{{/crossLink}} method.
 *  
 * @class Configuration 
 * @constructor
 */
