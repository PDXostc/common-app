Name:       wrt-plugins-ivi-most
Summary:    JavaScript plugin to access Most for WebRuntime
Version:    0.8.6
Release:    1
...
%package devel
Summary:    Wrt-plugins-ivi-most development headers
Group:      Development/Libraries
Requires:   %{name} = %{version}

%description devel
Wrt-plugins-ivi-most development headers
...
%files
%manifest wrt-plugins-ivi-most.manifest 
%{_libdir}/wrt-plugins/*
/usr/etc/tizen-apis/*
