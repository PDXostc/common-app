...
(function ($) {
     ...
     * This component is required by {{#crossLink "CarTheme.Library"}}{{/crossLink}} class.
     *
     ...
     *  
     * * {{#crossLink "CarTheme.BoxCaption/init:method"}}{{/crossLink}} - Standard size of rectangle and light text color 
     * (e.g. Exterior brightness in {{#crossLinkModule "DashboardApplication"}}{{/crossLinkModule}})     
     * * {{#crossLink "CarTheme.BoxCaption/initSmall:method"}}{{/crossLink}} - Small size of rectangle and light text color 
     * (e.g. Category title in {{#crossLink "CarTheme.Library"}}{{/crossLink}})
     *
    ...
    /** 
     * jQuery extension method for {{#crossLink "CarTheme.BoxCaption"}}{{/crossLink}} plugin.
