 ...
 * {{#crossLink "Services.Bootstrap"}}{{/crossLink}} class and can be later accessed using {{#crossLink "Services.Bootstrap/themeEngine:property"}}{{/crossLink}} object. Component uses
 * {{#crossLink "Services.Configuration"}}{{/crossLink}} class to persist selected theme in key specified by {{#crossLink "Services.ThemeEngine/selectedThemeKey:property"}}{{/crossLink}}.
 *
 * List of available themes is stored in {{#crossLink "Services.ThemeEngine/_themes:property"}}{{/crossLink}} property; new theme can be set using 
 * {{#crossLink "Services.ThemeEngine/setUserTheme:method"}}{{/crossLink}} method.
 * 
 * To attach to signal indicating update of currently selected theme use {{#crossLink "Services.ThemeEngine/addStatusListener:method"}}{{/crossLink}} method, e.g.:
 * 
