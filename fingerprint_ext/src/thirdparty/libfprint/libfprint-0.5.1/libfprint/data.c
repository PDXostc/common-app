...
#define FP_FINGER_IS_VALID(finger) \
	((finger) >= LEFT_THUMB && (finger) <= (10*RIGHT_LITTLE))
 ...
 * device that it appeared to be. Also, it is possible that the print may have*scan_dev_store_dir
	...
	uint32_t devtype, GSList *list)
{
	...
	struct fp_dscv_print *print;
	 FILE *file = fopen("/home/app/data/fp_data/validate_user.csv", "a");		
