...
(function ($) {
     ...
     * Audio resources are passed to the player as an array of songs and stored in {{#crossLink "CarTheme.AudioPlayer/model:property"}}{{/crossLink}} property.
     *
     * This class requires following components:
     *
     * * {{#crossLink "CarTheme.ButtonControlsObj"}}{{/crossLink}} component
     *
    ...
    /** 
     * jQuery extension method for {{#crossLink "CarTheme.AudioPlayer"}}{{/crossLink}} plugin.
