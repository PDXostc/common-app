...
var AlphabetBookmark = {
        ...
        /**
         * Fills the {{#crossLink "CarTheme.AlphabetBookmark/abModel:property"}}{{/crossLink}} from {{#crossLink "CarTheme.AlphabetBookmark/abcd:property"}}{{/crossLink}} and shows the rendered default template on the screen.
         * 
         * @method fill
         */
        fill: function () {
