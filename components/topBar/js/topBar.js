...
function callApp(appId) {
  tizen.application.getAppsContext(function(e) {
    onRunningAppsContext(e, appId)
  });
}
...
function initTaskLauncher() {
  ...
  if (typeof tizen !== 'undefined') {
    try {
      ...
      if (tizen.application.getCurrentApplication().appInfo.packageId == "JLRPOCX001")
        $("#homeScreenIcon").attr('src', '/DNA_common/images/tizen_inactive.png');
      else
...
function initIcon() {
  ...
  taskList = [{
    source: "/DNA_common/images/application_icons/googlemaps_inactive.png",
    cb: "JLRPOCX015.Navigation"
  }, {
    source: "/DNA_common/images/application_icons/browser_inactive.png",
    cb: "JLRPOCX030.Browser"
  }, {
    source: "/DNA_common/images/application_icons/dashboard_inactive.png",
    cb: "JLRPOCX033.Dashboard"
  }, {
    source: "/DNA_common/images/application_icons/hvac_inactive.png",
    cb: "JLRPOCX008.HVAC"
  }, {
    source: "/DNA_common/images/application_icons/weather_inactive.png",
    cb: "JLRPOCX035.Weather"
  }, {
    source: "/DNA_common/images/application_icons/fmradio_inactive.png",
    cb: "JLRPOCX004.FMRadio"
  }, {
    source: "/DNA_common/images/application_icons/nfc_inactive.png",
    cb: "JLRPOCX034.NFC"
  }];
  displayTasks();
  initAppGrid();
