...
var IncomingCall = function() {
	"use strict";
	/** 
	 * Class provides accept/deny for incoming call dialog in every widget. This component is usually initialized by {{#crossLink "Services.Bootstrap"}}{{/crossLink}} class
     * and can be later accessed using {{#crossLink "Services.Bootstrap/incomingCall:property"}}{{/crossLink}} property.
     *
