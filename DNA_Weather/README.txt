...
KnownIssues:
	User-added locations are not persistent between sessions. Trac #189
	Adding locations that are already in the list results in inconsistent behavior. Trac #188
	Weather may occasionally get stuck on the hourly forecast. Trac #68
	Due to GPS issues, Weather is hardcoded to a set of coordinates (Roswell). Trac #67
	Severe weather alerts will reappear at regular intervals. Trac #19
