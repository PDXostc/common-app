 ...
 * This component is usually initialized by {{#crossLink "Services.Bootstrap"}}{{/crossLink}} class and can be
 * later accessed using global {{#crossLink "Services.Speech"}}{{/crossLink}} object.
 * 
 ...
 * 
 * To attach to particular recognized speech commands register new callback object using {{#crossLink "Services.Speech/addVoiceRecognitionListener:method"}}{{/crossLink}} method. 
 *
 * To execute TTS for particular sentence use {{#crossLink "Services.Speech/vocalizeString:method"}}{{/crossLink}} method.
 * 
 * @class Speech
 * @constructor
 */
