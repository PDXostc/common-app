 ...
 * 
 * * {{#crossLink "CarTheme.BoxCaption"}}{{/crossLink}} component
 *
 * This class is usually loaded from {{#crossLink "Settings.Settings"}}{{/crossLink}} component and since this component is included in every Tizen PoC
...
(function ($) {
	...
	var Tabs = {
			 ...
			 * Triggers {{#crossLink "CarTheme.Tabs/eventClick_showPage:event"}}eventClick_showPage{{/crossLink}} event.
			 * 
			 * @method showPage
			 */
			showPage: function () {
				...
				/**
				 * Fired when {{#crossLink "CarTheme.Tabs/showPage:method"}}showPage{{/crossLink}} is called.
			 ...
			 * Triggers {{#crossLink "CarTheme.Tabs/eventClick_hidePage:event"}}eventClick_hidePage{{/crossLink}} event.
			 * 
			 * @method hidePage
			 */
			hidePage: function () {
				...
				/**
				 * Fired when {{#crossLink "CarTheme.Tabs/hidePagee:method"}}hidePage{{/crossLink}} is called.
				 * It's standard JQuery event and it fires on Tabs object.
				 * 
			...
			/**
			 * Shows sub panel and triggers {{#crossLink "CarTheme.Tabs/eventClick_showSubpanel:event"}}eventClick_showSubpanel{{/crossLink}} event if triggerEvent == true.
			 * 
			 * @method showSubpanel
			 * @param triggerEvent {Boolean} Control if {{#crossLink "CarTheme.Tabs/eventClick_showSubpanel:event"}}eventClick_showSubpanel{{/crossLink}} will be triggered.
			 */
			showSubpanel: function (triggerEvent) {
				if ($("#tabsTopSubPanel").is(":hidden")) {
					...
					if (!!triggerEvent) {
						/**
						 * Fired on sub panel showing caused by calling {{#crossLink "CarTheme.Tabs/showSubpanel:method"}}Tabs.showSubpanel(triggerEvent: boolean){{/crossLink}} method.
						 * It's standard JQuery event and it fires on Tabs object.
						 * 
			...
			/**
			 * Hides sub panel and triggers {{#crossLink "CarTheme.Tabs/eventClick_closeSubpanel:event"}}eventClick_closeSubpanel{{/crossLink}} event if triggerEvent == true.
			 * 
			 * @method closeSubpanel
			 * @param triggerEvent {Boolean} Control if {{#crossLink "CarTheme.Tabs/eventClick_closeSubpanel:event"}}eventClick_closeSubpanel{{/crossLink}} will be triggered.
			 */
			closeSubpanel: function (triggerEvent) {
				if ($("#tabsTopSubPanel").is(":visible")) {
					...
					if (!!triggerEvent) {
						/**
						 * Fired on sub panel closing caused by calling {{#crossLink "CarTheme.Tabs/closeSubpanel:method"}}Tabs.closeSubpanel(triggerEvent: boolean){{/crossLink}} method.
						 * It's standard JQuery event and it fires on Tabs object.
						 * 
			...
			/**
			 * Triggers {{#crossLink "CarTheme.Tabs/eventClick_menuItemBtn:event"}}eventClick_menuItemBtn(triggerEvent: boolean){{/crossLink}} event automatically after clicking on tab.
			...
			tabsTabClick: function (index) {
				...
				/**
				 * Fired on {{#crossLink "CarTheme.Tabs/tabsTabClick:method"}}Tabs.tabsTabClick(index: number){{/crossLink}} method call.
				 * It's standard JQuery event and it fires on Tabs object.
				 * 
				 * **indexObject example:**
				 * 
	...
	/** 
	 * jQuery extension method for for {{#crossLink "CarTheme.Tabs"}}{{/crossLink}} plugin.
